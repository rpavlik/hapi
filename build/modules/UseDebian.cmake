...
if(UNIX)
	if(NOT CMAKE_AR)
		...
		if(NOT DEFINED "CPACK_PACKAGE_NAME")
			message(FATAL_ERROR
				"CPack was not included, you should include CPack before Using UseDebian")
		endif()
...
")
			...
			add_custom_target(deb_destdir_install
				COMMAND
				${CMAKE_MAKE_PROGRAM}
				DESTDIR=${CMAKE_BINARY_DIR}/debian_package
				install
				DEPENDS
				${CMAKE_BINARY_DIR}/cmake_install.cmake
				COMMENT
				"Building debian_package directory with DESTDIR")
			...
			add_custom_command(OUTPUT
				...
				${CMAKE_BINARY_DIR}/debian_package
				COMMENT
				"Generating data.tar.gz")


			# get all the files to be installed:
			find_package(Md5sum REQUIRED)
			compute_md5sums(${CMAKE_BINARY_DIR}/debian_package
			...
			add_custom_command(OUTPUT
				${CMAKE_BINARY_DIR}/control.tar.gz
				WORKING_DIRECTORY
				${CMAKE_BINARY_DIR}
				COMMAND
				cmake
			...
			add_custom_command(OUTPUT
				${CMAKE_BINARY_DIR}/${DEBIAN_PACKAGE_NAME}_${CPACK_PACKAGE_VERSION}-1_${DEBIAN_ARCHITECTURE}.deb
				COMMAND
				${CMAKE_AR}
				ARGS
				-r
			...
			set_directory_properties(PROPERTIES
				...
				"debian-binary;control;md5sums;debian_package;")
