...
if(SEARCH_FOR_CHAI3D)
	...
	find_path(CHAI3D_INCLUDE_DIR
		...
		DOC
		"Path in which the file chai3d.h ( cWorld.h for chai3d versions earlier than 2.0 ) is located.")
	...
	if(WIN32)
		...
		find_library(CHAI3D_LIBRARY
			...
			DOC
			"Path to ${CHAI3D_LIBRARY_NAME} library.")
		if(MSVC80 OR MSVC90 OR MSVC10)
			find_library(CHAI3D_DEBUG_LIBRARY
				NAMES
				${CHAI3D_LIBRARY_NAME}_d
				PATHS
				$ENV{H3D_EXTERNAL_ROOT}/${LIB}/static
				$ENV{H3D_ROOT}/../External/${LIB}/static
				../../External/${LIB}/static
				${module_file_path}/../../../External/${LIB}/static
				DOC
				"Path to ${CHAI3D_LIBRARY_NAME}_d library.")
		endif()
		...
		find_library(CHAI3D_LIBRARY
			...
			chai3d
			DOC
			"Path to chai3d_linux (or chai3d) library.")
	endif()
else()
	set(CHAI3D_INCLUDE_DIR
		...
		CACHE
		PATH
		"Path to include files for chai3d. The path is to where chai3d.h ( cWorld.h for chai3d versions earlier than 2.0 ) is located.")
...
if(CHAI3D_INCLUDE_DIR AND CHAI3D_LIBRARIES_FOUND)
	...
	if(MSVC80 OR MSVC90 OR MSVC10)
		if(CHAI3D_LIBRARY)
			...
			message(STATUS
				"Chai3D release libraries not found. Release build might not work.")
		endif()
		...
		if(CHAI3D_DEBUG_LIBRARY)
			...
			set(CHAI3D_LIBRARIES
				...
				${CHAI3D_LIBRARY_NAME}_d)
			message(STATUS
				"Chai3D debug libraries not found. Debug build might not work.")
		endif()
	else()
...
if(NOT CHAI3D_FOUND)
	...
	if(MSVC80 OR MSVC90 OR MSVC10)
		set(CHAI3D_DIR_MESSAGE "${CHAI3D_DIR_MESSAGE}, CHAI3D_DEBUG_LIBRARY")
	endif()
	set(CHAI3D_DIR_MESSAGE
