...
find_path(NIFALCONAPI_INCLUDE_DIR
	...
	PATHS
	$ENV{FALCON_SUPPORT}/include
	"/Program Files/NiFalcon/include"
	$ENV{NOVINT_DEVICE_SUPPORT}/include
	DOC
	"Path in which the files falcon/comm/FalconCommLibFTDI.h, falcon/firmware/FalconFirmwareNovintSDK.h, falcon/kinematic/FalconKinematicStamper.h, falcon/util/FalconFirmwareBinaryNvent.h, falcon/core/FalconDevice.h are located.")
...
set(HAVE_NI_FALCON_COMM_LIBRARY
	(
	NIFALCONAPI_COMM_FTD2XX_LIBRARY
	AND
	(
	NOT
	WIN32
	OR
	NIFALCONAPI_LIBFTD2XX_LIBRARY
	)
	)
	OR
	NIFALCONAPI_COMM_USB_LIBRARY
	OR
	NIFALCONAPI_COMM_FTDI_LIBRARY)
...
if(NIFALCONAPI_INCLUDE_DIR
	AND
	HAVE_NI_FALCON_COMM_LIBRARY
	AND
	NIFALCONAPI_LIBRARY
	AND
	Boost_FOUND)
	...
	if(NIFALCONAPI_COMM_FTD2XX_LIBRARY)
		...
		if(WIN32)
			if(NOT DEFINED NIFALCONAPI_LIBFTD2XX_LIBRARY)
				set(NIFALCONAPI_LIBFTD2XX_LIBRARY
					""
					CACHE
					FILEPATH
